...
int CvCity::foodDifferenceTimes100(bool bBottom, CvString* toolTipSink) const
{
    VALIDATE_OBJECT
    int iDifference;
    int FoodProd = getYieldRate(YIELD_FOOD, false);
    int iPreMod = 100;
    int iPostMod = 0;
    int FinalPreMod;
    int FinalMod;
...
// WLTKD Growth Bonus
    ...
    else
    {
        ...
        FinalMod = (((iDifference + FinalPreMod) * 100) - ((iDifference + FinalPreMod) * -iPostMod)) / 100;
    }
...
BuildingTypes CvCity::ChooseFreeGardenBuilding() const
{
    ...
    for (int iI = 0; iI < GC.getNumBuildingClassInfos(); iI++)
    {
        ...
        {
            return static_cast<BuildingTypes>(getCivilizationInfo().getCivilizationBuildings(iI));
        }
    }
